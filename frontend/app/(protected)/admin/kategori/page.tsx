...
import { getCategories, getProducts, deleteCategory, Category, Product, getCategoryImage } from "@/lib/api";
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Button className="h-9 w-full sm:w-auto gap-2 bg-zinc-900 text-white text-sm font-medium" onClick={() => window.location.href = "/admin/kategori/tambah"}>
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-3">
                            {category.thumbnail ? (
                              ...
                              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-zinc-50 text-xl border border-zinc-100">
                                {category.icon}
                              </div>
                            ) : (
                              <div className="relative h-10 w-10 shrink-0 overflow-hidden rounded-lg border border-zinc-100 bg-zinc-50">
