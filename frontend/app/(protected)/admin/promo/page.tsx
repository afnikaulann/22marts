  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Button className="h-9 w-full sm:w-auto gap-2 bg-zinc-900 text-white text-sm font-medium hover:bg-zinc-800" onClick={() => window.location.href = "/admin/promo/tambah"}>
