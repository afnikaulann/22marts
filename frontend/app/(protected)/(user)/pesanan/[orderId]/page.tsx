...
import { getOrderByOrderId, Order } from "@/lib/api";
  ...
  if (!order) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <Link href="/pesanan" className="mt-2 text-sm text-zinc-500 hover:text-zinc-900 underline">Kembali</Link>
      </div>
    );
  }
  ...
  return (
    <>
      <div className="space-y-4 print:hidden">
        {/* Top bar with back button and Cetak button */}
        <div className="flex items-center justify-between mb-2">
          <Link href="/pesanan" className="inline-flex items-center gap-2 text-sm text-zinc-500 hover:text-zinc-900 font-medium">
            <ChevronLeft className="h-4 w-4" />
            Kembali ke Pesanan
          </Link>
          <Button onClick={() => window.print()} className="h-9 gap-2 rounded-lg bg-zinc-900 text-white hover:bg-zinc-800">
      ...
      <div className="rounded-lg border border-zinc-200 bg-white overflow-hidden">
        ...
        {/* Summary - Right side */}
        <div className="border-l border-zinc-100 p-4 space-y-2.5">
        ...
        <div className="grid grid-cols-4 divide-x divide-zinc-100 border-t border-zinc-100">
          <div className="p-4">
            <p className="text-xs text-zinc-500">No. Pesanan</p>
            <p className="mt-1 text-sm font-medium font-mono text-zinc-600">{order.orderId}</p>
    ...
    {/* Printable Receipt */}
    <div className="hidden print:block p-8 bg-white text-zinc-900 font-sans max-w-sm mx-auto break-inside-avoid">
      ...
      <div className="text-center mb-6 flex flex-col items-center">
        ...
        />
        <h1 className="text-xl font-bold tracking-tight">22Mart</h1>
        <p className="text-xs font-medium text-zinc-600 mt-1">Supermarket Online Terpercaya</p>
      ...
      <div className="space-y-2 text-xs mb-6">
        ...
        <div className="flex justify-between">
          ...
          <span className="text-zinc-900">{order.shippingName}</span>
        </div>
        <div className="flex justify-between">
          <span className="text-zinc-500">No. Telp:</span>
          <span className="text-zinc-900">{order.shippingPhone}</span>
        </div>
      </div>

      <div className="border-b border-dashed border-zinc-300 mb-4" />
      <h2 className="text-xs font-bold text-zinc-900 mb-3">DAFTAR BELANJA</h2>

      <div className="space-y-4 mb-6">
        {order.items.map((item) => (
          <div key={item.id} className="text-xs">
            <div className="flex justify-between font-medium text-zinc-900 gap-2">
      ...
      <div className="space-y-2 text-xs mb-6">
        ...
        <div className="border-b border-dashed border-zinc-300 my-3" />
      ...
      <div className="border-b border-dashed border-zinc-300 mb-6" />

      <div className="text-center text-[10px] text-zinc-400 space-y-1">
        <p>Terima kasih telah berbelanja di 22Mart!</p>
