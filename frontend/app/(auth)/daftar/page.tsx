        ...
        <div className="w-full max-w-md">
          <div className="rounded-2xl border border-purple-100 bg-white p-8 shadow-sm">
            <div className="text-center">
              ...
              <h1 className="mt-6 text-xl font-semibold text-foreground">Buat Akun Baru</h1>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              ...
              <div className="flex items-start gap-2">
                <input
                  ...
                  type="checkbox"
                  required
                  className="mt-0.5 h-4 w-4 rounded border-purple-200 text-secondary focus:ring-secondary"
                />
